...
//function mostRebounds(playerReboundSum){
...
//HIGHEST GUARD PERCENTAGE STILL NEEDS WORK 
...
console.log("PRACTICING DIVISION"); 
console.log(2/4); 
...
// var numbers = ['1', '2', '3', '4']; 
// var summing = numbers.reduce(function(sum, three){
// 	 var n = parseInt(three); 
// 	return sum + n; 
// }, 0);
...
// 	{name: 'blake', species: 'dog'}, 
// 	{name: 'hallo', species: 'fish'}, 
// 	{owner: 'Haley', mother: 'Cathy'}
// 	] 

// 	var dogs = animals.filter(function(animal){ 
// 		//var specialName = animal.name; 
// 		//return animal.name == 'blake'; 
// 		//return specialName; 
